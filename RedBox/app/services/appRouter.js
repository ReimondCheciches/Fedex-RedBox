(function () {
    var myApp = angular.module('Redbox', ['ngRoute', 'ngMaterial', 'LocalStorageModule', 'toastr', 'ngAnimate']);
    ...
    myApp.run(['$rootScope', 'authService', '$location', '$route', function ($rootScope, authService, $location, $route) {
